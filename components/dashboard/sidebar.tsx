...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Laporan PR",         href: "/dashboard/reports/priority-ranking", roles: ["owner", "kepala_toko"] },
      { label: "Laporan Penjualan",  href: "/dashboard/reports/sales",            roles: ["owner"] },
    ],
  },
  {
    type: "link",
